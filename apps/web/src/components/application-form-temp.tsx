...
export function ApplicationFormTemp({ isEditing = false, application, onSubmit }: ApplicationFormProps) {
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full h-10 px-3 py-2 border rounded-md bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50"
            >
              <option value="">{candidates.length === 0 ? '无可用候选人' : '请选择候选人'}</option>
          ...
          <div>
            ...
            <select
              ...
              className="w-full h-10 px-3 py-2 border rounded-md bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50"
            >
              <option value="">{jobs.length === 0 ? '无可用职位' : '请选择职位'}</option>
              {jobs.map((job) => (
          ...
          <div>
            ...
            <select
              ...
              className="w-full h-10 px-3 py-2 border rounded-md bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring"
            >
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setFormData({ ...formData, transparencyLevel: e.target.value as any })}
              className="w-full h-10 px-3 py-2 border rounded-md bg-background text-sm focus:outline-none focus:ring-2 focus:ring-ring"
            >
